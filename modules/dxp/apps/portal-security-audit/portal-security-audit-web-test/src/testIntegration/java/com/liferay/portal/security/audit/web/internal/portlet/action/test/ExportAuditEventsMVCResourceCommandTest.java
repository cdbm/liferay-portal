...
public class ExportAuditEventsMVCResourceCommandTest {
	...
	public void testBuildCSV() throws Exception {
		...
		Assert.assertEquals(
			StringUtil.merge(_DEFAULT_COLUMNS, StringPool.COMMA), lines[0]);
	}
	...
	public void testGetColumns() throws Exception {
		try (ConfigurationTemporarySwapper configurationTemporarySwapper =
			...
			Assert.assertArrayEquals(
				_DEFAULT_COLUMNS, _getColumns(TestPropsValues.getCompanyId()));
		}
	}
	...
	private static final String[] _DEFAULT_COLUMNS = {
